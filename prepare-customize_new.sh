...
dl_dir=$PWD/egs/customize_new/download
...
audio_feats_dir=egs/customize_new/data/tokenized

. egs/customize_new/shared/parse_options.sh || exit 1


# All files generated by this script are saved in "data".
# You can safely remove "data" and rerun this script to regenerate it.
mkdir -p egs/customize_new/data
...
if [ $stage -le 0 ] && [ $stop_stage -ge 0 ]; then
  ...
  if [ ! -e ${audio_feats_dir}/.customize.tokenize.done ]; then
    python3 bin/tokenizer.py --dataset-parts "${dataset_parts}" \
        ...
        --prefix "customize"\
        --batch-duration 400 \
        --src-dir "egs/customize_new/data/manifests" \
