...
. egs/aishell1/shared/parse_options.sh || exit 1


# All files generated by this script are saved in "data".
# You can safely remove "data" and rerun this script to regenerate it.
mkdir -p egs/aishell1/data
...
if [ $stage -le 1 ] && [ $stop_stage -ge 1 ]; then
  ...
  # to $dl_dir/aishell
  mkdir -p egs/aishell1/data/manifests
  if [ ! -e egs/aishell1/data/manifests/.aishell.done ]; then
    lhotse prepare aishell $dl_dir/aishell egs/aishell1/data/manifests
    touch egs/aishell1/data/manifests/.aishell.done
  fi
fi
